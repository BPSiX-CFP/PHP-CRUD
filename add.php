        ...
        <div class="card-body">
          ...
          <form method="POST" action="add.php">
            <div class="mb-3 row">
              ...
              <div class="col-md-6">
                <input id="name" type="text" value="<?php if (isset($_POST['name'])) {echo ($_POST['name']);} ?>" class="form-control" name="name" autocomplete="name" autofocus>
              </div>
            </div>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-6">
                <input id="phone_number" type="tel" value="<?php if (isset($_POST['num'])) {echo ($_POST['num']);} ?>" class="form-control" name="num" autocomplete="phone_number" autofocus>
              </div>
            </div>
